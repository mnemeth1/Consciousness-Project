...
**Version 1 is the current reviewed, scoped provisional synthesis. Phase 2 is unfinished.**

- [Executive summary](release/v1/Executive_Summary.md)
- [Full synthesis](release/v1/Consciousness_and_Existence_Synthesis.md)
- [Open questions](release/v1/Open_Questions_and_Next_Research.md)
