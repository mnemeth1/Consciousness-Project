...
Authors cannot approve their own research. A distinct reviewer must inspect decisive passages and report unresolved disagreements before a maintainer accepts a research change. Disclose AI assistance and the actual review performed. Do not claim a source was read, an analysis was executed or a review was completed when it was not.

Contribute project-owned prose, code and bibliographic metadata. Do not upload third-party books, papers, transcripts, screenshots or full-text extracts without redistribution rights. Supply citations and concise paraphrases instead. Keep credentials, private personal information and machine-specific paths out of changes.

Contributions are submitted under the repository's existing Unlicense to the extent you hold the relevant rights. Third-party material keeps its own license. Publication permission for a document does not imply permission to redistribute the sources it cites.
