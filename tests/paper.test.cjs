...
function auxSources(version) {
  ...
  return {
    landing: `<!doctype html><html lang="en"><head>${head}<title>Fixture landing</title></head><body><main><h1>Fixture landing</h1>${notice}<p><a href="paper.html">Article</a> <a href="companion.html">Overview</a> <a href="thesis.html">Thesis</a> <a href="methodology.html">Method</a> <a href="paper.pdf">PDF</a></p></main></body></html>`,
...
test('landing, companion, thesis and methodology build one bound seven-file artifact and publish seven assets', async () => {
  ...
  assert.equal(C.sha(fs.readFileSync(path.join(directory, 'methodology.html'))), manifest.methodology_html_sha256);
