...
**Research article 0.3.0 — Consciousness, Existence, and the Grounds of Significance:** [read the paper](https://mnemeth1.github.io/Consciousness-Project/), [download the matching PDF](https://mnemeth1.github.io/Consciousness-Project/paper.pdf), or [view the versioned release](https://github.com/mnemeth1/Consciousness-Project/releases/tag/paper-v0.3.0). A complete philosophical manuscript based on the research available so far; later versions will refine arguments and supporting evidence. [Release procedure](docs/PAPER_RELEASE.md) · [Changelog](paper/CHANGELOG.md).
